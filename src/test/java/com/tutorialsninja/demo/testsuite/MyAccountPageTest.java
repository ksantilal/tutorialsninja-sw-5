...
public class MyAccountPageTest extends BaseTest {
        ...
        public void verifyThatUserRegisterAccountSuccessfully(){
            myAccountPage.clickOnMyAccountLink();
            myAccountPage.selectMyAccountOptions("Register");
            myAccountPage.enterFirstName("Smith");
            myAccountPage.enterLastName("Dannis");
            myAccountPage.enterEmailId("smithd123@gmail.com");
            myAccountPage.enterPhoneNumber("07701217018");
            myAccountPage.enterPassword("SmithDan");
            myAccountPage.enterConfirmPassword("SmithDan");
